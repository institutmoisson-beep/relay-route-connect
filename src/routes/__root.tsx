...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MSN Delivery — La livraison collaborative" },
      { property: "og:description", content: "Livraison par points relais en Côte d'Ivoire. Transformez votre espace en relais et gagnez de l'argent." },
